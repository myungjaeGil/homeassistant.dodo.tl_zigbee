...
void drv_pwm_cfg(u8 pwmId, u16 cmp_tick, u16 cycle_tick)
{
    ...
    printf("drv_pwm_cfg entered. pwmId=%d, cycle_tick=%d, cmp_tick=%d\r\n",pwmId, cycle_tick, cmp_tick);
...
#elif defined(MCU_CORE_B91) || defined(MCU_CORE_B92) || defined(MCU_CORE_TL721X) || defined(MCU_CORE_TL321X)
    printf("drv_pwm_cfg entered. defined(MCU_CORE_B91) || defined(MCU_CORE_B92) || defined(MCU_CORE_TL721X) || defined(MCU_CORE_TL321X)\r\n");
